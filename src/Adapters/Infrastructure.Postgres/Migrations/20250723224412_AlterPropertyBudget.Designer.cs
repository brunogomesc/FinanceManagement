...
namespace Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20250723224412_AlterPropertyBudget")]
    partial class AlterPropertyBudget
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Modules.Accounts.Entities.Profiles.Profile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Modules.Accounts.Aggregates.Account", b =>
                {
                    b.OwnsOne("Domain.Modules.Accounts.ValuesObjects.Address.Address", "Address", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Modules.Accounts.Entities.Profiles.Profile", b =>
                {
                    b.HasOne("Domain.Modules.Accounts.Aggregates.Account", "Account")
                        .WithOne("Profile")
                        .HasForeignKey("Domain.Modules.Accounts.Entities.Profiles.Profile", "AccountId")
            ...
            modelBuilder.Entity("Domain.Modules.Budgets.Aggregates.Budget", b =>
                {
                    b.OwnsMany("Domain.Modules.Budgets.ValuesObjects.Categories.Category", "Categories", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.OwnsMany("Domain.Modules.Budgets.ValuesObjects.Transactions.Transaction", "Transactions", b2 =>
                                {
                                    b2.Property<int>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("integer");
